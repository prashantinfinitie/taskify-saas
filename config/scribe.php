...
return [
    ...
    'title' => config('app.name').'Taskify SaaS - API Documentation',
    ...
    'base_url' => "https://dev-taskify-saas.infinitietech.in/",
        ...
        'order' => [
            ...
            'Status Management' => [
              'GET /status/{id?}',
                ...
                'PUT /statuses/{id}',
                'DELETE /statuses/{id}',
                'DELETE /destroy-multiple-statuses',
            ],
            'Client Management' => [
                'GET /clients/{id?}',
                'POST /clients',
            ...
            'Contracts'=>[
                ...
                'DELETE /contracts/{id}',
                'POST /contract-types/store',
                'PUT /contracts-types/{id}',
