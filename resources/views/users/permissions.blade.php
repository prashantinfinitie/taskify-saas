    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                {{ get_label('user_permissions', 'User Permissions') }} - {{ $user->first_name }} {{ $user->last_name }}
            </div>
            <div class="card-body">
                                                        ...
                                                        <div class="form-check mx-4">
                                                            @if ($role->guard_name == 'client')
                                                                ...
                                                                <input type="checkbox" name="permissions[]"
                                                                    value="{{ $permissionModel ? $permissionModel->name : '' }}"
                                                            ...
                                                            @else
                                                                <input type="checkbox" name="permissions[]"
                                                                    value="<?php print_r(Permission::findByName($permission)->name); ?>"
                                                                    class="form-check-input permission-checkbox"
                                                                    data-module="{{ $module }}"
                                                                    {{ $mergedPermissions->contains('name', $permission) ? 'checked' : '' }}>
                                                                <label
