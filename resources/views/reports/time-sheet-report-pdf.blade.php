        ...
        <div class="report-content">
            <table class="summary-table">
                <tr>
                    ...
                    <td class="summary-item">
                        <div class="summary-label">Total Hours</div>
                        <div class="summary-value">{{ $summary->project_total_hours }}</div>
                    </td>
                    <td class="summary-item">
            ...
            <div class="section">
                <h2 class="section-title">Time Sheet Details</h2>
                <table>
                    <thead>
                        <tr>
                            <th rowspan="2" scope="col">{{ get_label('id', 'ID') }}</th>
                            <th rowspan="2" scope="col">{{ get_label('user', 'User') }}</th>
                            <th rowspan="2" scope="col">{{ get_label('project', 'Project') }}</th>
                            <th rowspan="2" scope="col">{{ get_label('task', 'Task') }}</th>
                            <th colspan="2" scope="col">{{ get_label('time_entries', 'Time Entries') }}</th>
                            <th colspan="2" scope="col">{{ get_label('time', 'Time') }}</th>
                        </tr>
                        <tr>
                            <th scope="col">{{ get_label('start_time', 'Start Time') }}</th>
                            <th scope="col">{{ get_label('end_time', 'End Time') }}</th>
                            <th scope="col">{{ get_label('total', 'Total') }}</th>
                            <th scope="col">{{ get_label('message', 'Message') }}</th>
                        </tr>
                    </thead>
                    <tbody>
