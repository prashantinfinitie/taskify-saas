        ...
        <tbody>
            <tr>
                <td style="box-sizing: border-box; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';"
                    align="center">
                    <table
                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; margin: 0px; padding: 0px; width: 100%; height: 659.844px;"
                        role="presentation" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr style="height: 77.0938px;">
                                <td
                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; padding: 25px 0px; height: 77.0938px; text-align: center;">
                                    <span style="font-size: 18px;">{COMPANY_LOGO}</span>
                                </td>
                            </tr>
                            <tr style="height: 486.25px;">
                                <td style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; background-color: rgb(237, 242, 247); margin: 0px; padding: 0px; width: 100%; border: hidden !important; height: 486.25px;"
                                    width="100%">
                                    <table class="m_2051327272198114809inner-body"
                                        ...
                                        role="presentation" width="570" cellspacing="0" cellpadding="0" align="center">
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        You have a Todo reminder for Todo #<strong>{TODO_ID} -
                                                            {TODO_TITLE}</strong>. You can view the Todo here:
                                                        {TODO_URL}. </p>
                                                    <table
                                                            ...
                                                            <tr>
                                                                <td style="box-sizing: border-box; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';"
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        role="presentation" border="0" width="100%"
                                                                                    ...
                                                                                    <table
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td
                                                                                                    style="box-sizing: border-box; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';">
                                                                                                    <a class="m_2051327272198114809button"
                                                                                                        ...
                                                                                                        target="_blank"
                                                                                                        rel="noopener"
                                                                                                        data-saferedirecturl="https://www.google.com/url?q=http://127.0.0.1:8000/email/verify/129/9e323bcc5df5fdff3fe6ff960fd6576204a510ca?expires%3D1710157052%26signature%3D2df5df03c59d0dcd960500989168d0bb4b064035d572bc4195ca5a912b0302e8&amp;source=gmail&amp;ust=1710333202290000&amp;usg=AOvVaw2RJnO33Iiu4v5j5tJBiQWH">View
                                                                                                        Todo Details</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        If you're having trouble clicking the "View Todo
                                                                        Details" button, copy and paste the URL below
                                                                        into your web browser: {TODO_URL}</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                            ...
                            <tr style="height: 96.5px;">
                                <td
                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; height: 96.5px;">
                                    <table class="m_2051327272198114809footer"
                                            ...
                                            <tr>
                                                <td style="box-sizing: border-box; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'; max-width: 100vw; padding: 32px;"
                                                    ...
                                                    <p
                                                        ...
                                                        &copy; {CURRENT_YEAR} {COMPANY_TITLE}. All rights reserved.</p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
